var JSONTree=function(root,respRoot,json){
	...
	if(obj){
		var sample=null;
		sample=this.createSample(obj,sample,"");console.log("Sample is ",JSON.stringify(sample));
		console.log(root,respRoot);
		console.log("Creating tree");this.showSample(sample,this.container,"",5);
		console.log("Passing ",this.respContainer);
		//this.indent(this,sample,respContainer,"",5);
	}
}
